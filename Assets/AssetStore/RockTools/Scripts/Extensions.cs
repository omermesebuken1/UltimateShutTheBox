...
namespace RockTools
{
    public static class Extensions
    {
        ...
        public static void ClearChildrenEditor(this Transform transform)
        {
            var children = transform.transform.childCount;
            for (var i = children - 1; i >= 0; i--)
                Object.DestroyImmediate(transform.transform.GetChild(i).gameObject);
        }
